      ...
      <section className="mx-auto w-full max-w-md rounded-2xl border border-[color:var(--app-border)] bg-[var(--app-surface)] p-5 shadow-sm sm:max-w-lg sm:p-6 md:max-w-xl md:p-8">
        ...
        <form className="space-y-3" onSubmit={handleEmailAuth}>
          ...
          <button
            ...
            className="inline-flex w-full items-center justify-center rounded-xl border border-red-200 bg-black px-4 py-2.5 text-sm font-semibold text-white hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 disabled:cursor-not-allowed disabled:opacity-60"
          >
