      ...
      <div className="mx-auto flex w-full max-w-[92rem] flex-col gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 md:gap-3 [direction:ltr]">
          <button
            ...
            className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-black bg-white text-black shadow-sm dark:border-white dark:bg-white dark:text-black"
          ...
          <button
            ...
            className={`whitespace-nowrap rounded-full border px-4 py-2 text-sm font-semibold transition-colors ${
              selectedCategory === "all"
                ? "border-black bg-white text-black dark:border-white dark:bg-white dark:text-black"
                : "border-black bg-white text-black dark:border-white dark:bg-white dark:text-black"
            }`}
          >
            الكل
