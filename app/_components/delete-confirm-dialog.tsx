      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 pt-1">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="inline-flex min-w-20 items-center justify-center rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm font-semibold text-red-700 dark:border-red-900/60 dark:bg-red-950/40 dark:text-red-300"
          >
            {confirmText}
          </button>
        </div>
