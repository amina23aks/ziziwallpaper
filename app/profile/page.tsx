...
export default function ProfilePage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md items-center bg-zinc-50 px-4 py-6 pb-24 md:max-w-5xl md:px-6 md:py-20">
      <section className="w-full rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm md:mx-auto md:max-w-lg md:p-8">
