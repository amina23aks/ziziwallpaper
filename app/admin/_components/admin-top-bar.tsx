...
export function AdminTopBar({
  ...
  return (
    <>
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-zinc-800 bg-zinc-950 text-zinc-100 md:hidden">
        <div className="flex min-h-14 items-center gap-3 px-4 py-2 [direction:ltr]">
          {leading ? (
            ...
            <Link
              href={backHref}
              className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-zinc-700 bg-zinc-900 text-zinc-100"
              aria-label="رجوع"
            >
              ←
            </Link>
          ...
          <div className="min-w-0 flex-1 [direction:rtl] text-right">
            <h1 className="truncate text-base font-bold text-zinc-100">{title}</h1>
      ...
      <header className="hidden space-y-2 text-right md:sticky md:top-0 md:z-30 md:-mx-6 md:block md:border-b md:border-zinc-800/70 md:bg-zinc-950/95 md:px-6 md:py-3 md:backdrop-blur lg:-mx-8 lg:px-8">
