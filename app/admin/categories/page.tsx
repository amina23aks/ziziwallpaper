                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 sm:flex-nowrap">
                    ...
                    <button
                      ...
                      className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-[#f3b6bc] bg-white px-3 py-2 text-xs font-semibold text-[#c40018] hover:bg-[#fff5f6] dark:border-[#8f1d2a] dark:bg-[#34131a] dark:text-[#ff9eaa] dark:hover:bg-[#412029] sm:flex-none"
                    >
                      حذف
                    </button>
                  </div>
