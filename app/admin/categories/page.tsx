      ...
      <section className="mt-3 space-y-3 md:mt-5">
        <div className="flex items-center justify-start [direction:ltr]">
          <button
            ...
            className="inline-flex items-center rounded-lg border border-zinc-300 bg-[var(--app-surface)] px-3 py-1.5 text-xs font-semibold text-[var(--app-text)] dark:border-white dark:bg-white dark:text-black"
          >
            إضافة تصنيف +
          </button>
        </div>
          ...
          <div className="rounded-xl border border-[color:var(--app-border)] bg-[var(--app-surface)] p-3">
            <div className="flex flex-col gap-2 sm:flex-row">
              ...
              <button
                ...
                className="rounded-lg border border-zinc-300 bg-[var(--app-surface-muted)] px-3 py-2 text-sm font-semibold text-[var(--app-text)] dark:border-white dark:bg-white dark:text-black"
              >
                حفظ
              </button>
            </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 sm:flex-nowrap">
                    {isEditing ? (
                      <>
                        <button
                          ...
                          className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-zinc-300 bg-[var(--app-surface-muted)] px-3 py-2 text-xs font-semibold text-[var(--app-text)] dark:border-white dark:bg-white dark:text-black sm:flex-none"
                        >
                          حفظ
                        </button>
                        <button
                          ...
                          className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-zinc-300 px-3 py-2 text-xs font-semibold text-[var(--app-text)] dark:border-white dark:bg-white dark:text-black sm:flex-none"
                        >
                          إلغاء
                        </button>
                      </>
                    ...
                    <button
                      ...
                      className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-red-200 bg-white px-3 py-2 text-xs font-semibold text-red-700 hover:bg-red-50 sm:flex-none"
                    >
                      حذف
                    </button>
                  </div>
