                    ...
                    {isEditing ? (
                      <>
                        <button
                          ...
                          className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-[color:var(--app-border)] bg-[var(--app-surface-muted)] px-3 py-2 text-xs font-semibold text-[var(--app-text)] sm:flex-none dark:border-white dark:bg-white dark:text-black"
                        >
                          حفظ
                        </button>
                        <button
                          ...
                          className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-[color:var(--app-border)] px-3 py-2 text-xs font-semibold text-[var(--app-text)] sm:flex-none dark:border-white dark:bg-white dark:text-black"
                        >
                          إلغاء
                        </button>
                      </>
