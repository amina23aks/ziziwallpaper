                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 sm:flex-nowrap">
                    ...
                    <button
                      ...
                      className="inline-flex min-w-20 flex-1 items-center justify-center rounded-lg border border-[#f2b5b5] bg-[#fff5f5] px-3 py-2 text-xs font-semibold text-[#c1121f] hover:bg-[#ffeaea] dark:border-red-700/70 dark:bg-red-950/35 dark:text-red-300 dark:hover:bg-red-950/55 sm:flex-none"
                    >
                      حذف
                    </button>
                  </div>
