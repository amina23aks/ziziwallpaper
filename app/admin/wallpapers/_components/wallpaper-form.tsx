        ...
        <div className="space-y-3 rounded-2xl border border-[color:var(--app-border)] bg-[var(--app-surface-muted)] p-3 sm:p-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              ...
              className="rounded-lg border border-transparent px-2 py-1 text-xs font-semibold text-[var(--app-text-muted)] dark:border-white dark:bg-white dark:text-black"
            >
              ➕ إضافة تصنيف
            </button>
          </div>
                ...
                <button
                  ...
                  className={`rounded-full border px-3 py-1.5 text-sm font-semibold ${
                    active
                      ...
                      : "border-[color:var(--app-border)] bg-[var(--app-surface)] text-[var(--app-text)] dark:border-white dark:bg-white dark:text-black"
                  }`}
                >
                  {category.nameAr}
                </button>
