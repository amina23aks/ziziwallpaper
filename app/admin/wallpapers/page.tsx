              ...
              >
                ...
                <div className="col-span-2 flex gap-2 sm:col-auto sm:justify-end">
                  <Link
                    ...
                    className="inline-flex flex-1 items-center justify-center rounded-lg border border-[color:var(--app-border)] bg-[var(--app-surface)] px-3 py-2 text-xs font-semibold text-[var(--app-text)] sm:flex-none dark:border-white dark:bg-white dark:text-black"
                  >
                    تعديل
                  </Link>
                  <button
